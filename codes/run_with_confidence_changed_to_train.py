import sys, os
from paths import OSV5M_REPO, CODES_DIR, SUBSET_TRAIN_CALIB_DIR, BASELINE_PATH, RESULTS_DIR
...
SUBSET_DIR = SUBSET_TRAIN_CALIB_DIR
...
out_path = os.path.join(RESULTS_DIR, "calib_train_with_confidence.csv")
